...
Et1                            up             up                 P2P_LINK_TO_POD01-SPINE1_Ethernet3
Et2                            up             up                 P2P_LINK_TO_POD01-SPINE2_Ethernet3
Et3                            up             up                 MLAG_PEER_POD01-LEAF1B_Ethernet3
Et4                            up             up                 POD01-SUBLEAF1A_Ethernet1
Et5                            up             up                 server-1_Eth1
Et6                            up             up                 
Et7                            up             up                 
Et8                            up             up                 
...
Po3                            up             up                 MLAG_PEER_POD01-LEAF1B_Po3
Po4                            up             up                 POD01_SUBLEAF1_Po1
Po5                            down           lowerlayerdown     server-1_PortChannel
...
-------------- ------------------ -------------- ------------ --------- ------- 
Ethernet1      10.0.3.1/31        up             up              1500           
Ethernet2      10.0.3.3/31        up             up              1500           
Loopback0      10.1.2.3/32        up             up             65535           
Loopback1      10.1.5.3/32        up             up             65535           
Management1    192.168.1.5/24     up             up              1500           
Vlan110        10.1.10.1/24       up             up              1500           
Vlan111        10.1.11.1/24       admin down     down            1500           
Vlan112        10.1.12.1/24       up             up              1500           
Vlan1008       unassigned         up             up              9164           
Vlan4092       10.160.255.2/24    up             up              1500           
Vlan4093       10.255.0.0/31      up             up              1500           
Vlan4094       10.255.1.0/31      up             up              1500
```
## show lldp neighbors
...
---------- ------------------------ ---------------------- --- 
Et1           POD01-SPINE1             Ethernet3           120 
Et2           POD01-SPINE2             Ethernet3           120 
Et3           POD01-LEAF1B             Ethernet3           120 
Et4           POD01-SUBLEAF1A          Ethernet1           120 
...
! device: POD01-LEAF1A (vEOS, EOS-4.25.0F)
!
...
interface Port-Channel3
   description MLAG_PEER_POD01-LEAF1B_Po3
...
!
interface Ethernet1
   description P2P_LINK_TO_POD01-SPINE1_Ethernet3
   no switchport
   ip address 10.0.3.1/31
   service-profile blah
!
interface Ethernet2
   description P2P_LINK_TO_POD01-SPINE2_Ethernet3
   no switchport
   ip address 10.0.3.3/31
   service-profile blah
!
interface Ethernet3
   description MLAG_PEER_POD01-LEAF1B_Ethernet3
   channel-group 3 mode active
!
interface Ethernet4
   description POD01-SUBLEAF1A_Ethernet1
...
router bgp 65101
   ...
   neighbor 10.0.3.2 peer group IPv4-UNDERLAY-PEERS
...
Hardware version: 
Serial number: 
Hardware MAC address: 50ba.00e5.2dcb
System MAC address: 50ba.00e5.2dcb
