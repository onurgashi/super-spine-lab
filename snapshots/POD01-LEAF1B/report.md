...
Et1                            up             up                 P2P_LINK_TO_POD01-SPINE1_Ethernet4
Et2                            up             up                 P2P_LINK_TO_POD01-SPINE2_Ethernet4
Et3                            up             up                 MLAG_PEER_POD01-LEAF1A_Ethernet3
Et4                            up             up                 POD01-SUBLEAF1A_Ethernet2
Et5                            up             up                 
Et6                            up             up                 
Et7                            up             up                 
Et8                            up             up                 
...
Po3                            up             up                 MLAG_PEER_POD01-LEAF1A_Po3
...
-------------- ------------------ -------------- ------------ --------- ------- 
Ethernet1      10.0.3.5/31        up             up              1500           
Ethernet2      10.0.3.7/31        up             up              1500           
Loopback0      10.1.2.4/32        up             up             65535           
Loopback1      10.1.5.3/32        up             up             65535           
Management1    192.168.1.6/24     up             up              1500           
...
Vlan4093       10.255.0.1/31      up             up              1500           
Vlan4094       10.255.1.1/31      up             up              1500
```
## show lldp neighbors
...
---------- ------------------------ ---------------------- --- 
Et1           POD01-SPINE1             Ethernet4           120 
Et2           POD01-SPINE2             Ethernet4           120 
Et3           POD01-LEAF1A             Ethernet3           120 
Et4           POD01-SUBLEAF1A          Ethernet2           120 
...
! device: POD01-LEAF1B (vEOS, EOS-4.25.0F)
!
...
interface Port-Channel3
   description MLAG_PEER_POD01-LEAF1A_Po3
...
!
interface Ethernet1
   description P2P_LINK_TO_POD01-SPINE1_Ethernet4
   no switchport
   ip address 10.0.3.5/31
   service-profile blah
!
interface Ethernet2
   description P2P_LINK_TO_POD01-SPINE2_Ethernet4
   no switchport
...
Hardware version: 
Serial number: 
Hardware MAC address: 50ba.002c.b23e
System MAC address: 50ba.002c.b23e
