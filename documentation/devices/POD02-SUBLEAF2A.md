...
| Vlan4092 | L2LEAF_INBAND_MGMT | default | 10.161.255.4/24 | 10.161.255.1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | POD02-LEAF3A_Ethernet4 | *trunk | *4092 | *- | *- | 1 |
| Ethernet2 | POD02-LEAF3B_Ethernet4 | *trunk | *4092 | *- | *- | 1 |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | POD02-LEAF3A_Po4 | switched | trunk | 4092 | - | - | - | - | - | - |
...
| default  | 0.0.0.0/0 |  10.161.255.1  |  -  |  1  |  -  |  -  |  - |
