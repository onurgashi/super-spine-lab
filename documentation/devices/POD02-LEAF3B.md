...
| --------- | --------------- | ------------ | --------- |
| POD02_LEAF3 | Vlan4094 | 10.255.1.0 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_POD02-LEAF3A_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | POD02-SUBLEAF2A_Ethernet2 | *trunk | *110-112,4092 | *- | *- | 4 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 |  P2P_LINK_TO_POD02-SPINE3_Ethernet4  |  routed  | - |  10.0.4.5/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet2 |  P2P_LINK_TO_POD02-SPINE4_Ethernet4  |  routed  | - |  10.0.4.7/31  |  default  |  1500  |  false  |  -  |  -  |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_POD02-LEAF3A_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| Vlan4092 |  default  |  10.161.255.3/24  |  -  |  10.161.255.1  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.0.1/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- |
| 10.0.4.4 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 10.0.4.6 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
