...
| --------- | --------------- | ------------ | --------- |
| POD01_LEAF2 | Vlan4094 | 10.255.1.4 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_POD01-LEAF2A_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 |  P2P_LINK_TO_POD01-SPINE1_Ethernet6  |  routed  | - |  10.0.3.13/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet2 |  P2P_LINK_TO_POD01-SPINE2_Ethernet6  |  routed  | - |  10.0.3.15/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet4 |  P2P_LINK_TO_ROUTE-SERVER1_Ethernet2  |  routed  | - |  10.0.2.2/31  |  default  |  1500  |  false  |  -  |  -  |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_POD01-LEAF2A_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.1.2.6/32 |
...
| Vlan4092 |  default  |  10.160.255.3/24  |  -  |  10.160.255.1  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.0.5/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- |
| 10.0.2.3 | 65000 | default |
| 10.0.3.12 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 10.0.3.14 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 10.11.33.1 | 65000 | default |
| 10.255.0.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default |
