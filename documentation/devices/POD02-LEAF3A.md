...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 192.168.1.13/24 | 192.168.1.254 |
...
| --------- | --------------- | ------------ | --------- |
| POD02_LEAF3 | Vlan4094 | 10.255.1.1 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_POD02-LEAF3B_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | POD02-SUBLEAF2A_Ethernet1 | *trunk | *110-112,4092 | *- | *- | 4 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 |  P2P_LINK_TO_POD02-SPINE3_Ethernet3  |  routed  | - |  10.0.4.1/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet2 |  P2P_LINK_TO_POD02-SPINE4_Ethernet3  |  routed  | - |  10.0.4.3/31  |  default  |  1500  |  false  |  -  |  -  |
...
!
interface Ethernet1
   description P2P_LINK_TO_POD02-SPINE3_Ethernet3
   no shutdown
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_POD02-SPINE4_Ethernet3
   no shutdown
   no switchport
...
!
interface Ethernet3
   description MLAG_PEER_POD02-LEAF3B_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description POD02-SUBLEAF2A_Ethernet1
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_POD02-LEAF3B_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
| Port-Channel4 | POD02_SUBLEAF2_Po1 | switched | trunk | 110-112,4092 | - | - | - | - | 4 | - |
...
interface Port-Channel3
   description MLAG_PEER_POD02-LEAF3B_Po3
   no shutdown
   switchport
...
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.1.6.3/32 |
...
| Vlan4092 |  default  |  10.161.255.2/24  |  -  |  10.161.255.1  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.0.0/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- |
| 10.0.4.0 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 10.0.4.2 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 10.11.33.1 | 65000 | default |
| 10.255.0.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 110 | 65501:10110 |  65000:10110 |  -  | -  | learned |
| 111 | 65501:50111 |  65000:50111 |  -  | -  | learned |
| 112 | 65501:50112 |  65000:50112 |  -  | -  | learned |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Common_VRF | 65501:1025 | connected |
...
router bgp 65501
   ...
   neighbor 10.255.0.1 peer group MLAG-IPv4-UNDERLAY-PEER
